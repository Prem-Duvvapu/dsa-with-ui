...
> historical. The live system has 433 unique catalogue ids and 39 tracers; the frontend uses
...
CURRENT NUMBERS (433/440/7 are pinned by ProblemsApiTest — update the test if you change them)
    ...
    39 traced. README.md carries the current checked list; GET /api/problems/stats is
