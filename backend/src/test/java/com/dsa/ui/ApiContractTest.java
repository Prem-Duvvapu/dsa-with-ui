...
class ApiContractTest {
    ...
    static Stream<Arguments> retiredTraces() {
        return Stream.of(
                ...
                arguments("/api/stackqueue", "infix-to-postfix"),
                arguments("/api/stackqueue", "infix-to-prefix"),
                arguments("/api/stackqueue", "prefix-to-infix"),
                arguments("/api/stackqueue", "prefix-to-postfix"),
                arguments("/api/stackqueue", "postfix-to-prefix"),
                arguments("/api/stackqueue", "postfix-to-infix"),
