...
public class HeapTrieGreedyTracingTest {
    ...
    void testKthLargestTracing() {
        // kth-largest-element has a real tracer now — the legacy path retires it rather
        // than serving substitute steps. Content is pinned by its golden file.
        assertThrows(LegacyTraceRetiredException.class,
                () -> heapService.generateSteps("kth-largest-element"));
    }
