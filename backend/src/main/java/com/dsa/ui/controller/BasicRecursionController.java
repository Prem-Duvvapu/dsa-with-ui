...
@RestController
@RequestMapping("/api/basic-recursion")
public class BasicRecursionController {

    private final BasicRecursionService service;

    public BasicRecursionController(BasicRecursionService service) {
