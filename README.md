...
`kadane-algo`, `kmp-lps-algo`, `knapsack-01`, `koko-eating-bananas`, `largest-rectangle-histogram`, `lower-bound`, `minimum-falling-path-sum`,
`ninjas-training`,
...
`max-sum-non-adjacent`, `merge-two-sorted-arrays`, `move-zeros-end`,
