...
**Status: 433 problems catalogued, 406 with real execution traces.** Those two numbers are
...
**Recursion & Backtracking** problems, and all 31 **Linked List & Doubly LL** problems.
